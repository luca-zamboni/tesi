...
\section{Cambio Cartelli}
	...
	\subsection{Implementazione nuovo riconoscimento}
		...
		\myalg{\algo{ROI,cartello}{}}{
			...
			$originalWidth \longleftarrow ROI.width$\;
			$originalHeight \longleftarrow ROI.height$\;
			$ROI \longleftarrow biancoNero(ROI)$\;
			$ROI \longleftarrow resize(ROI,N)$\;
			$ROI \longleftarrow cutBorderBalck(ROI)$\;
			$ROI \longleftarrow cutBorderWhite(ROI)$\;
			...
			$ROI \longleftarrow resize(ROI,N)$\;
			$ROI \longleftarrow resize(cartello,N)$\;
